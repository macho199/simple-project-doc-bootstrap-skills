...
Codex용 `simple-project-doc-bootstrap` 스킬을 담고 있는 저장소입니다.
...
스킬은 아래 4개 문서를 프로젝트의 최소 기준 문서로 유지하는 방향을 제안합니다.
...
Codex에서 `simple-project-doc-bootstrap` 스킬을 사용해 달라고 요청하면 됩니다. 스킬은 저장소의 현재 상태를 먼저 파악한 뒤, 필요할 경우 최소 문서 세트를 만들거나 기존 문서를 정리하고, 작업 후에는 관련 문서를 현재 상태 기준으로 다시 맞춥니다.
